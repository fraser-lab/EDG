...
from edg.config import load_config, save_config, ExperimentConfig, merge_overrides
...
class TestConfigLoading:
    ...
    def test_load_simple_config(self):
        ...
        config_data = {
            ...
            "structure": {"structure_path": "/fake/path/structure.cif"},
            "density": {"map_path": "/fake/path/density.ccp4", "resolution": 2.0},
        ...
        try:
            ...
            from edg.config.config_loader import (
                create_experiment_config,
                parse_schedule_configs,
            )
    ...
    def test_config_validation_missing_files(self):
        ...
        config_data = {
            "name": "test_experiment",
            "structure": {"structure_path": "/nonexistent/structure.cif"},
            "density": {"map_path": "/nonexistent/density.ccp4", "resolution": 2.0},
            "output_dir": "/fake/output",
            "input_data_dir": "/fake/input",
        }
    ...
    def test_config_validation_missing_resolution(self):
        ...
        try:
            ...
            from edg.config.config_schema import (
                ExperimentConfig,
                StructureConfig,
                DensityConfig,
            )
...
class TestSchedules:
    ...
    def test_piecewise_schedule(self):
        ...
        schedule = PiecewiseScheduleConfig(breakpoints=[0.25, 0.75], values=[0, 1.0, 0])
        actual_schedule = schedule.to_schedule()
        assert hasattr(
            actual_schedule, "compute"
        )  # Should be a PiecewiseSchedule object

    def test_exponential_schedule(self):
        """Test exponential interpolation schedule."""
        schedule = ExponentialInterpolationConfig(start=0.1, end=1.0, alpha=2.0)
        actual_schedule = schedule.to_schedule()
...
class TestOverrides:
    ...
    def test_merge_nested_overrides(self):
        ...
        overrides = {"density_guidance.base_weight": 0.8, "steering.num_particles": 5}
        merged = merge_overrides(config_data, overrides)
...
class TestConfigSaving:
    ...
    def test_save_and_load_config(self):
        ...
        try:
            ...
            assert (
                loaded_config.structure.structure_path
                == config.structure.structure_path
            )
